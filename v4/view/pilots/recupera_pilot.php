<div id="alta">
	<p id="titols_accions">Recuperar pilot donat de baixa</p>
...
?>
	<form id="baixa2" method="post" action="../controller/valida_pilot.php">
	<table>
	...
	<input type="submit" name="alta" value="Activar" />
</form>
<?php
}
